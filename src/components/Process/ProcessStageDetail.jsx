...
import briefImage from "../../assets/images/Work/Large exterior image.png";
import conceptImage from "../../assets/images/Work/Image 01.png";
import refinementImage from "../../assets/images/Work/Image 02.png";
import coordinationImage from "../../assets/images/Work/Image 03.png";
import constructionImage from "../../assets/images/Work/Image 04.png";
import useProcessStageDetailEffects from "./ProcessStageDetailEffects";
import styles from "./ProcessStageDetail.module.css";

const stages = [
  { number: "01", short: "Brief\nBreakdown", title: "Brief Breakdown", image: briefImage, alt: "Waterfront residence at dusk", intro: "We examine the brief, site, priorities, budget and constraints to establish a clear understanding of the project.", detail: "Through careful analysis and early conversations, we uncover the real needs, opportunities and limitations that will guide every decision ahead." },
  { number: "02", short: "Strategies", title: "Strategies", image: conceptImage, alt: "Conceptual architectural exterior", intro: "We define the guiding ideas, spatial priorities and practical approach that will shape every design decision.", detail: "Clear strategy becomes the foundation that ensures coherence through all subsequent phases of the project." },
  { number: "03", short: "Design\nPhase", title: "Design Phase", image: refinementImage, alt: "Refined interior architectural space", intro: "We translate the agreed strategy into a thoughtful architectural proposal, coordinating space, form, material and experience.", detail: "Every element is resolved with care so the design remains clear in its intent from concept through delivery." },
  { number: "04", short: "Approval", title: "Approval", image: coordinationImage, alt: "Coordinated planted architectural threshold", intro: "We refine and document the proposal, incorporating feedback and preparing it for the required client and regulatory approvals.", detail: "Clarity in documentation and coordination ensures the design intent is understood and supported through the approval process." },
  { number: "05", short: "Construction", title: "Construction", image: constructionImage, alt: "Completed waterfront exterior", intro: "We carry the approved design into delivery, protecting its intent through coordination, detailing and construction oversight.", detail: "The process remains focused through delivery, ensuring every part of the project is built with the same care that shaped it." },
];
